...
final class GetCurrentLifecycleTrafficHandler implements QueryHandlerInterface
{
    /**
     * @var CommandBus
     */
    ...
    /**
     * GetCurrentLifecycleTrafficHandler constructor.
    ...
    /**
     * @param GetCurrentLifecycleTrafficQuery $query
     * @return int
     * @throws \Exception
     */
    public function handle(GetCurrentLifecycleTrafficQuery $query): int
    {
        /**
        ...
        return $this->logCleanTaskRepository->getConsumedUploadBandwidthInBytes(
            $query->getUser(),
            $currentCycleStart,
            $currentCycleEnd
        );
